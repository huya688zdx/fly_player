  ...
  static const List<MpvSettingDefinition> definitions = <MpvSettingDefinition>[
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '不额外处理色带。'),
        MpvSettingOption(
          value: 'low',
          label: 'Low',
          description: '轻度消除色带，保留更多画面细节。',
        ),
        MpvSettingOption(
          value: 'medium',
          label: 'Medium',
          description: '加强色带处理，适合色带较明显的画面。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '保留原始画面细节。'),
        MpvSettingOption(
          value: 'low',
          label: 'Low',
          description: '轻微增强画面边缘清晰度。',
        ),
        MpvSettingOption(
          value: 'medium',
          label: 'Medium',
          description: '更明显地增强画面锐度。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '不额外降噪。'),
        MpvSettingOption(value: 'low', label: 'Low', description: '轻度减少画面噪点。'),
        MpvSettingOption(
          value: 'medium',
          label: 'Medium',
          description: '更强地减少画面噪点。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '仅在需要时启用反交错。',
        ),
        MpvSettingOption(value: 'off', label: 'Off', description: '始终关闭反交错处理。'),
        MpvSettingOption(
          value: 'force',
          label: 'Force',
          description: '始终启用反交错处理。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'fast',
          label: 'Fast',
          description: '优先降低缩放处理开销。',
        ),
        MpvSettingOption(
          value: 'balanced',
          label: 'Balanced',
          description: '平衡缩放画质与功耗。',
        ),
        MpvSettingOption(
          value: 'quality',
          label: 'Quality',
          description: '优先使用更高质量的画面缩放。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '自动选择 HDR 处理方式。',
        ),
        MpvSettingOption(
          value: 'sdr_map',
          label: 'SDR Map',
          description: '将 HDR 映射为 SDR，优先保证显示兼容性。',
        ),
        MpvSettingOption(
          value: 'enhanced',
          label: 'Enhanced',
          description: '在显示设备支持时优先尝试 HDR 直出。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '使用默认色调映射曲线。',
        ),
        MpvSettingOption(
          value: 'bt2390',
          label: 'BT.2390',
          description: '标准参考曲线，兼顾亮度与细节。',
        ),
        MpvSettingOption(
          value: 'mobius',
          label: 'Mobius',
          description: '保留中间调，让高光平缓过渡。',
        ),
        MpvSettingOption(
          value: 'hable',
          label: 'Hable',
          description: '呈现电影风格，增强画面对比。',
        ),
        MpvSettingOption(
          value: 'reinhard',
          label: 'Reinhard',
          description: '使用简单映射，让高光更柔和。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'off',
          label: 'Off',
          description: '保持原始帧率，不启用插帧。',
        ),
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '根据片源条件自动决定是否插帧。',
        ),
        MpvSettingOption(
          value: 'on',
          label: 'On',
          description: '启用插帧，提升运动画面的流畅度。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '使用默认的音画同步策略。',
        ),
        MpvSettingOption(
          value: 'audio',
          label: 'Audio',
          description: '以音频时钟为准，优先保证声音连续。',
        ),
        MpvSettingOption(
          value: 'smooth',
          label: 'Smooth',
          description: '更积极地适配显示刷新节奏。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'default',
          label: 'Default',
          description: '根据片源自动选择缓存策略。',
        ),
        MpvSettingOption(
          value: 'low_latency',
          label: 'Low Latency',
          description: '优先减少跳转和切换时的等待。',
        ),
        MpvSettingOption(
          value: 'stable',
          label: 'Stable',
          description: '增加预读缓存，缓解网络波动。',
        ),
        MpvSettingOption(
          value: 'network',
          label: 'Network',
          description: '为远程片源使用更大的预读缓存。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '跟随当前缓存策略。',
        ),
        MpvSettingOption(
          value: '64',
          label: '64 MB',
          description: '减少缓存占用的内存。',
        ),
        MpvSettingOption(
          value: '128',
          label: '128 MB',
          description: '更适合远程直链播放。',
        ),
        MpvSettingOption(
          value: '256',
          label: '256 MB',
          description: '缓解网络波动带来的播放卡顿。',
        ),
        MpvSettingOption(
          value: '512',
          label: '512 MB',
          description: '适合高码率片源或不稳定的网络。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: '100', label: '100%', description: '使用标准音量上限。'),
        MpvSettingOption(
          value: '150',
          label: '150%',
          description: '提高音量上限，适合对白偏轻的片源。',
        ),
        MpvSettingOption(
          value: '200',
          label: '200%',
          description: '使用最高音量增益，可能产生失真。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'off',
          label: 'Off',
          description: '保留当前设置的音频处理。',
        ),
        MpvSettingOption(
          value: 'on',
          label: 'On',
          description: '关闭大部分音频后处理，保留原始声音。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'off',
          label: 'Off',
          description: '保留原始声音动态范围。',
        ),
        MpvSettingOption(value: 'low', label: 'Low', description: '轻度突出对白。'),
        MpvSettingOption(
          value: 'medium',
          label: 'Medium',
          description: '缩小响声与轻声的差距，更适合夜间播放。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '保留原始音色。'),
        MpvSettingOption(
          value: 'soft',
          label: 'Soft',
          description: '轻微调整低频与人声。',
        ),
        MpvSettingOption(
          value: 'clarity',
          label: 'Clarity',
          description: '突出人声与高频细节。',
        ),
        MpvSettingOption(
          value: 'cinema',
          label: 'Cinema',
          description: '兼顾低频氛围与对白清晰度。',
        ),
        MpvSettingOption(
          value: audioEqCustomValue,
          label: 'Custom',
          description: '使用多频段自定义均衡器。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '不额外限制声音峰值。'),
        MpvSettingOption(
          value: 'light',
          label: 'Light',
          description: '轻度控制突然增大的声音。',
        ),
        MpvSettingOption(
          value: 'strong',
          label: 'Strong',
          description: '加强峰值限制，减少声音削波失真。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '保留原始低频。'),
        MpvSettingOption(value: 'low', label: 'Low', description: '轻度增强低频。'),
        MpvSettingOption(
          value: 'medium',
          label: 'Medium',
          description: '更明显地增强低频。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(value: 'off', label: 'Off', description: '保留原始人声音色。'),
        MpvSettingOption(value: 'low', label: 'Low', description: '轻度突出对白。'),
        MpvSettingOption(
          value: 'medium',
          label: 'Medium',
          description: '更明显地突出对白。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '根据设备与片源选择声道输出。',
        ),
        MpvSettingOption(
          value: 'stereo',
          label: 'Stereo',
          description: '优先使用立体声输出。',
        ),
        MpvSettingOption(
          value: 'surround',
          label: 'Surround',
          description: '使用多声道输出，保留更多环绕声信息。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'off',
          label: 'Off',
          description: '由播放器解码，兼容性最好。',
        ),
        MpvSettingOption(
          value: 'auto',
          label: 'Auto',
          description: '设备支持时，将音频码流交给外部设备解码。',
        ),
        MpvSettingOption(
          value: 'on',
          label: 'On',
          description: '强制直通音频码流，需要外接设备支持。',
        ),
      ],
    ),
    MpvSettingDefinition(
      ...
      options: <MpvSettingOption>[
        MpvSettingOption(
          value: 'default',
          label: 'Default',
          description: '使用默认的播放兼容方案。',
        ),
        MpvSettingOption(
          value: 'conservative',
          label: 'Conservative',
          description: '减少高开销渲染与滤镜处理。',
        ),
        MpvSettingOption(
          value: 'software_fallback',
          label: 'Software',
          description: '需要回退时，优先使用更稳妥的软件解码方案。',
        ),
      ],
    ),
  ];
