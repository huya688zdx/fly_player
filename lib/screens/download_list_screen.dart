...
class _DownloadListScreenState extends State<DownloadListScreen> {
  ...
  Future<void> _handleBackNavigation() async {
    if (_exitEditingMode()) return;
    await EmbeddedDetailLauncher.closeHostOrPop(context);
  }
          ...
          _reentryToken = NativePlaybackReentry.bind(
            ...
            onResolvePlayback:
                (
                  ...
                  subtitleGuid,
                  audioGuid,
                  // 下载列表单条目路径本期不接序号/画质继承；声明以匹配桥接器函数类型。
                  audioTrackIndex,
                  subtitleTrackIndex,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              AppLocalizations.of(context).downloadMultipleVersions,
              style: TextStyle(
