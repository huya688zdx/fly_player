...
import 'fly_catalog_screen.dart';
...
class SettingsDestinationRoutes {
  ...
  static const String flyCatalog = '/screen/settings/fly-catalog';
  ...
  static List<String>? buildNavigationStack(String routeName) {
    ...
    switch (uri.path) {
      ...
      case flyCatalog:
        return const <String>[home, flyCatalog];
      case other:
  ...
  static Widget? buildRoute(String routeName, {Key? key}) {
    ...
    switch (uri.path) {
      ...
      case flyCatalog:
        return FlyCatalogScreen(key: key);
      case other:
