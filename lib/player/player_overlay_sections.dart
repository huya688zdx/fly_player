...
const Color kPlayerProgressBlue = Color(0xFF1E7BFF);
                          ...
                          Positioned.fill(
                            child: SliderTheme(
                              data: SliderTheme.of(context).copyWith(
                                ...
                                activeTrackColor: kPlayerProgressBlue,
                                inactiveTrackColor: Colors.white24,
                                thumbColor: Colors.white,
                                overlayColor: const Color(0x331E7BFF),
                              ),
                              child: Slider(
                                min: 0,
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: active ? kPlayerProgressBlue : const Color(0xD9161B20),
