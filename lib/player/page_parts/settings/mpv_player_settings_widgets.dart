...
class PlaybackSettingsChoiceTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleColor = selected ? colors.selectionStrong : colors.textPrimary;
    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: onTap,
...
class PlaybackSettingsSliderTile extends StatelessWidget {
  final String title;
  final String subtitle;
  final String valueLabel;
  final double value;
  ...
  const PlaybackSettingsSliderTile({
    super.key,
    required this.title,
    required this.subtitle,
    required this.valueLabel,
...
class PlaybackDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      decoration: _settingsCardDecoration(context, alpha: 0.04),
      child: Padding(
...
class _SelectionIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      child: selected
          ? Icon(Icons.check_rounded, size: 15, color: colors.textPrimary)
          : null,
    );
  }
}
