              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  ...
                  color: Color.alphaBlend(
                    colors.surface.withValues(alpha: isWide ? 0.88 : 0.94),
                    colors.overlayScrim.withValues(alpha: isWide ? 0.22 : 0.34),
                  ),
                  border: isWide
...
class _EpisodeTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final durationColor = colors.textMuted;
    final borderColor = wide
        ? (item.selected
              ? colors.selection.withValues(alpha: 0.34)
              : colors.borderSubtle)
        : Colors.transparent;
    final backgroundColor = wide
        ? (item.selected ? colors.selectionSoft : Colors.transparent)
        : Colors.transparent;
