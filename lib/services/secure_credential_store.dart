...
import 'secure_credential_store_linux.dart';
...
class SecureCredentialStore {
  ...
  /// Android 和 Apple 使用原生通道，Windows 使用 DPAPI，Linux 使用桌面密钥环。
  ...
  static SecureCredentialBackend _defaultBackend() {
    ...
    if (Platform.isLinux) return const LinuxSecureCredentialBackend();
